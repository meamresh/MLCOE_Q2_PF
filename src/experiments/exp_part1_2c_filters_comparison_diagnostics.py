...
def _run_scenario_worker(scenario_dict: dict, filter_names: List[str], args_dict: dict, scenario_idx: int) -> List[ExperimentResult]:
    ...
    from src.experiments.exp_part1_2c_filters_comparison_diagnostics import run_scenario_experiment
...
# python -m src.experiments.exp_part1_2c_filters_comparison_diagnostics --filters pfpf_ledh pfpf_edh ledh edh pff_scalar pff_matrix