...
#python3 -m src.experiments.exp_part1_1f_runtime_memory --scaling --num-trials 10

# Run comprehensive evaluation with 5000 particles
#python3 -m src.experiments.exp_part1_1f_runtime_memory --comprehensive --num-particles 5000

# Run both with custom parameters
#python3 -m src.experiments.exp_part1_1f_runtime_memory --scaling --comprehensive --num-steps 150 --seed 123