...
# Same config as the d=2 T=50 grid-fix run, only T=50 -> T=1000, with a CLIPPED pilot (40x40).
#
...
D=2; T=1000; N=64; NLAMBDA=10; K=10; NBASIS=64
...
HIDDEN_UNITS=128; NUM_HIDDEN=3; LHNN_EPOCHS=6000; PILOT_TRAJ=40; PILOT_STEPS=40   # CLIPPED pilot (1640 grads vs 3660) to cut the T=1000 pilot ~2.2x
