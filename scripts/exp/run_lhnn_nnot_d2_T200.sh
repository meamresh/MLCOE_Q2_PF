...
# Same config as the d=2 T=50 grid-fix run, only T=50 -> T=200.
#
...
D=2; T=200; N=64; NLAMBDA=10; K=10; NBASIS=64
...
HIDDEN_UNITS=128; NUM_HIDDEN=3; LHNN_EPOCHS=4000; PILOT_TRAJ=60; PILOT_STEPS=60
